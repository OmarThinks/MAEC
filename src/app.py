...
def create_app(DOCKER=False,testing=TESTING):
	...
	print("Found the autoincrement: "+str(sample.id.comparator.autoincrement))
	print("Found the  default: "+str(sample.id.comparator.default))
	print("Found the  autoincrement: "+str(sample.id.comparator.autoincrement))
	print("Found the  foreign_keys: "+str(sample.id.comparator.foreign_keys))
	print("Found the  key: "+str(sample.id.comparator.key))
	print("Found the  name: "+str(sample.id.comparator.name))
	print("Found the  nullable: "+str(sample.id.comparator.nullable))
	print("Found the  primary_key: "+str(sample.id.comparator.primary_key))
	print("Found the  type: "+str(sample.id.comparator.type))
	print("Found the  unique: "+str(sample.id.comparator.unique))
